...
object LikeRecipeUseCase {
    suspend operator fun invoke(
        ...
        val data = recipeRepository.getById(id!!).last().data?: return ApiResponse(RecipeStatus.RECIPE_NOT_FOUND, "recipe not found", null)
        val user = userRepository.getByToken(token!!).last().data?: return ApiResponse(UserStatus.USER_NOT_FOUND, INVALID_TOKEN, null)
